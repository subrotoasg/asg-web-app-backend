...
const updateCouseSubjectValidationSchema = z.object({
  body: z.object({
    title: z
      .string()
      ...
      .trim()
      .optional(),
    courseSubjectImage: z.string().optional(),
    serial: z
      .number()
...
export const courseSubjectValidationSchema = {
  createCourseSubjectValidationSchema,
  updateCouseSubjectValidationSchema,
};
